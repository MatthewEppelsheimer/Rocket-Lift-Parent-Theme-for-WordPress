				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<header class="entry-header">
						...
						<nav id="image-navigation" class="site-navigation">
							<span class="previous-image"><?php previous_image_link( false, __( '&larr; Previous', 'rocket_lift_parent_theme' ) ); ?></span>
							<span class="next-image"><?php next_image_link( false, __( 'Next &rarr;', 'rocket_lift_parent_theme' ) ); ?></span>
						...
						<div class="entry-attachment">
							<div class="attachment">
								...
								<a href="<?php echo $next_attachment_url; ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="attachment"><?php
									$attachment_size = apply_filters( 'rocket_lift_parent_theme_attachment_size', array( 1200, 1200 ) ); // Filterable image size.
